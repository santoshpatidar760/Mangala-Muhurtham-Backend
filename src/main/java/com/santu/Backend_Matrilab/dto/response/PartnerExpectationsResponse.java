...
public class PartnerExpectationsResponse {
    ...
    public PartnerExpectationsResponse(Long id, Long userId, String generalRequirement, Integer minimumAge,
                                       Integer maximumAge, Integer minimumHeight, Integer maximumHeight,
                                       Integer maximumWeight, String maritalStatus, String religion,
                                       String complexion, String smokingHabits, String drinkingStatus,
                                       String minimumDegree, String profession, String languages,
                                       String personality, String financialCondition, String familyPosition) {
        this.id = id;
        this.userId = userId;
