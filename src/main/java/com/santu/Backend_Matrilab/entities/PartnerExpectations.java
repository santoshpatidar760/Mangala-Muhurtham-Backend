...
public class PartnerExpectations {
    ...
    public PartnerExpectations(Long id, User user, String generalRequirement, Integer minimumAge, Integer maximumAge, Integer minimumHeight, Integer maximumHeight, Integer maximumWeight, String maritalStatus, String religion, String complexion, String smokingHabits, String drinkingStatus, String minimumDegree, String profession, String languages, String personality, String financialCondition, String familyPosition) {
        this.id = id;
        this.user = user;
        this.generalRequirement = generalRequirement;
        this.minimumAge = minimumAge;
